...
internal class LearnMoreObject {
    ...
    class func setUpTitleString(for pageIndex: Int, learnMoreObject: LearnMoreObject, learnMoreButton: UIButton) -> NSAttributedString? {
        ...
        if pageIndex == 0 {
            ...
            let partOne = learnMoreObject.title.createTextAttributes(foregroundColor: .blue, strokeColor: .blue, font: UIFont(name: Constants.FontNames.openSansCondensedLight, size: 30)!)
            ...
            let partOne = learnMoreObject.title.createTextAttributes(foregroundColor: .blue, strokeColor: .blue, font: UIFont(name: Constants.FontNames.openSans, size: 16)!)
            let partTwo = learnMoreObject.info.createTextAttributes(foregroundColor: .darkGray, strokeColor: .darkGray, font: UIFont(name: Constants.FontNames.openSans, size: 16)!)
