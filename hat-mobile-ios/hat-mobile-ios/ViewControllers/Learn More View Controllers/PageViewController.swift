...
internal class PageViewController: UIViewController {
    ...
    @IBAction func moreInfoActionButton(_ sender: Any) {
        ...
        if let pageItemController = self.storyboard!.instantiateViewController(withIdentifier: "CapabilitiesPageViewController") as? HATCapabilitiesPageViewController {
            ...
            pageItemController.view.createFloatingView(frame: CGRect(x: self.view.frame.origin.x + 15, y: self.view.frame.maxY, width: self.view.frame.width - 30, height: self.view.frame.height - 30), color: .blue, cornerRadius: 15)
    ...
    override func viewDidLoad() {
        ...
        self.pageViewController?.changePaginationColors(pageTintColor: .white, pageCurrentTintColor: .blue)
        ...
        if itemIndex == 6 {
            ...
            let partTwo = "hub of all things".createTextAttributes(foregroundColor: .blue, strokeColor: .blue, font: UIFont(name: Constants.FontNames.openSans, size: 36)!)
