...
internal class DataStoreContactInfoTableViewController: UITableViewController, UserCredentialsProtocol {
    ...
    @IBAction func saveButtonAction(_ sender: Any) {
        ...
        self.loadingView = UIView.createLoadingView(with: CGRect(x: (self.view?.frame.midX)! - 70, y: (self.view?.frame.midY)! - 15, width: 140, height: 30), color: .blue, cornerRadius: 15, in: self.view, with: "Updating profile...", textColor: .white, font: UIFont(name: Constants.FontNames.openSans, size: 12)!)
