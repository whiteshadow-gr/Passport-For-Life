...
internal class MapViewController: UIViewController, MKMapViewDelegate, MapSettingsDelegate {
    ...
    private func createDatePickerAccessoryView() {
        ...
        spaceButton.setTitleTextAttributes([NSForegroundColorAttributeName: UIColor.blue], for: .normal)
        
        self.segmentControl = UISegmentedControl(items: ["From", "To"])
        self.segmentControl!.setTitleTextAttributes([NSForegroundColorAttributeName: UIColor.blue], for: .normal)
        ...
        self.segmentControl!.tintColor = .blue
        
        let barButtonSegmentedControll = UIBarButtonItem(customView: segmentControl!)
        
        let spaceButton2 = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.flexibleSpace, target: nil, action: nil)
        spaceButton2.setTitleTextAttributes([NSForegroundColorAttributeName: UIColor.blue], for: .normal)
