...
internal class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        let partTwo = "Lite".createTextAttributes(foregroundColor: .blue, strokeColor: .blue, font: UIFont(name: Constants.FontNames.openSansCondensedLight, size: 36)!)
        ...
        self.buttonLogon.backgroundColor = .blue
    ...
    private func hatLoginAuth(notification: NSNotification) {
        ...
        if let url = notification.object as? NSURL {
            ...
            popUpView!.createFloatingView(frame: CGRect(x: self.view.frame.midX - 60, y: self.view.frame.midY - 15, width: 120, height: 30), color: .blue, cornerRadius: 15)
